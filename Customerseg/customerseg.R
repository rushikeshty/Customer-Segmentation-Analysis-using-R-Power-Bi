...
print("The percentage of females is 56%, whereas the percentage of male in the customer dataset is 44%")
...
print("The maximum customer ages are between 30 and 35. The minimum age of customers is 18, whereas, the maximum age is 70.")
